...
tools/lazarus/lazbuild source/tzdb/dist/tzdb_fpc.lpk --quiet

echo "## compile package source/extrasyn/extrahighlighters.lpk"
tools/lazarus/lazbuild source/extrasyn/extrahighlighters.lpk --quiet  --ws=cocoa

echo "## compile package source/extrasyn/extrahighlighters_dsgn.lpk"
tools/lazarus/lazbuild source/extrasyn/extrahighlighters_dsgn.lpk --quiet --add-package

echo "## compile package source/ZXing.Delphi/Lazarus/Package/zxing.lpk"
tools/lazarus/lazbuild source/ZXing.Delphi/Lazarus/Package/zxing.lpk --quiet  --ws=cocoa --add-package --build-ide=

echo "## compile package source/lazarus-ide-tester/package/idetester.lpk"
tools/lazarus/lazbuild source/lazarus-ide-tester/package/idetester.lpk --quiet  --add-package

echo "## compile package source/lazarus-ide-tester/ide/idetester_dsgn.lpk"
tools/lazarus/lazbuild source/lazarus-ide-tester/ide/idetester_dsgn.lpk --quiet --add-package

echo "## compile package source/HtmlViewer/package/FrameViewer09.lpk"
tools/lazarus/lazbuild source/HtmlViewer/package/FrameViewer09.lpk --quiet --add-package

echo "## compile package source/delphi-markdown/packages/markdownengine.lpk"
tools/lazarus/lazbuild source/delphi-markdown/packages/markdownengine.lpk --quiet

echo "## compile package source/PdfiumLib/Package/Pdfium.lpk"
tools/lazarus/lazbuild source/PdfiumLib/Package/Pdfium.lpk --quiet --add-package --ws=cocoa
