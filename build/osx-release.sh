...
cp exec/pack/*.icns install/build/FHIRToolkit.app/Contents/Resources
...
codesign --force --options runtime --timestamp --deep --entitlements install/entitlements.plist --sign "Developer ID Application: Health Intersections Pty Ltd (632X4VRLLD)" install/build/FHIRToolkit.app/Contents/MacOS/libcrypto.1.1.dylib
codesign --force --options runtime --timestamp --deep --entitlements install/entitlements.plist --sign "Developer ID Application: Health Intersections Pty Ltd (632X4VRLLD)" install/build/FHIRToolkit.app/Contents/MacOS/libssl.1.1.dylib
codesign --force --options runtime --timestamp --deep --entitlements install/entitlements.plist --sign "Developer ID Application: Health Intersections Pty Ltd (632X4VRLLD)" install/build/FHIRToolkit.app/Contents/MacOS/FHIRToolkit
codesign --force --options runtime --timestamp --deep --entitlements install/entitlements.plist --sign "Developer ID Application: Health Intersections Pty Ltd (632X4VRLLD)" install/build/FHIRToolkit.app
