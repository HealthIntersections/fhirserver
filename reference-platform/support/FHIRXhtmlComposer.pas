unit FHIRXhtmlComposer;

interface

uses
  SysUtils, Classes,
  TextUtilities, StringSupport,
  AdvStringBuilders,
  MXml, XMLBuilder,
  FHIRBase, FHIRSupport, FHIRLang, FHIRParserBase, FHIRXhtml,
  {$IFDEF FHIR2}
  FHIRTypes2, FHIRResources2, FHIRContext2, FHIRTags2, FHIRConstants2;
  {$ENDIF}
  {$IFDEF FHIR3}
  FHIRTypes3, FHIRResources3, FHIRContext3, FHIRTags3, FHIRConstants3;
  {$ENDIF}
  {$IFDEF FHIR4}
  FHIRTypes4, FHIRResources4, FHIRContext4, FHIRTags4, FHIRConstants4;
  {$ENDIF}
