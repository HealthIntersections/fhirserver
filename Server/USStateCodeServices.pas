...
function TUSStateCodeServices.getDisplay(code : String):String;
var
  qry : TKDBConnection;
begin
...
procedure TUSStateCodeServices.Displays(code : String; list : TStringList);
begin
  list.Add(getDisplay(code));
end;


function TUSStateCodeServices.locate(code : String) : TCodeSystemProviderContext;
var
  qry : TKDBConnection;
...
function TUSStateCodeServices.Display(context : TCodeSystemProviderContext) : string;
begin
  result := TUSStateCodeConcept(context).FDisplay;
end;

procedure TUSStateCodeServices.Displays(context: TCodeSystemProviderContext; list: TStringList);
begin
...
function TUSStateCodeServices.searchFilter(filter : TSearchFilterText; prep : TCodeSystemProviderFilterPreparationContext) : TCodeSystemProviderFilterContext;
begin
  raise Exception.Create('not done yet');
end;

function TUSStateCodeServices.filter(prop : String; op : TFhirFilterOperator; value : String; prep : TCodeSystemProviderFilterPreparationContext) : TCodeSystemProviderFilterContext;
begin
  raise Exception.Create('not done yet');
end;

function TUSStateCodeServices.filterLocate(ctxt : TCodeSystemProviderFilterContext; code : String) : TCodeSystemProviderContext;
begin
  raise Exception.Create('not done yet');
end;
