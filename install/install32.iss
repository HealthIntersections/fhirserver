...
AppVerName=Version 1.0.235

; compilation control
OutputDir=C:\work\fhirserver\install\build
OutputBaseFilename=fhirserver32-1.0.235
...
; Executable files
Source: "C:\work\fhirserver\Exec\32\FHIRServer2.exe";        DestDir: "{app}";     DestName: "FHIRServer.exe";       Components: r2; Flags: ignoreversion
Source: "C:\work\fhirserver\Exec\32\FHIRServer3.exe";        DestDir: "{app}";     DestName: "FHIRServer.exe";       Components: r3; Flags: ignoreversion
Source: "C:\work\fhirserver\Exec\32\FHIRServer4.exe";        DestDir: "{app}";     DestName: "FHIRServer.exe";       Components: r4; Flags: ignoreversion
Source: "C:\work\fhirserver\Exec\32\FHIRServer2.debug.exe";  DestDir: "{app}";     DestName: "FHIRServer.debug.exe"; Components: r2; Flags: ignoreversion
Source: "C:\work\fhirserver\Exec\32\FHIRServer3.debug.exe";  DestDir: "{app}";     DestName: "FHIRServer.debug.exe"; Components: r3; Flags: ignoreversion
Source: "C:\work\fhirserver\Exec\32\FHIRServer4.debug.exe";  DestDir: "{app}";     DestName: "FHIRServer.debug.exe"; Components: r4; Flags: ignoreversion
Source: "C:\work\fhirserver\Exec\32\FHIRServerUtils.exe";    DestDir: "{app}";     DestName: "FHIRServerUtils.exe";                  Flags: ignoreversion
...
Source: "C:\work\fhirserver\Exec\openssl32.exe"; DestName: "openssl.dll";    DestDir: "{app}";      Flags: ignoreversion
