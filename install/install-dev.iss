...
; Executable files
Source: "C:\work\fhirserver\Exec\FHIRServer-dev32.exe";        DestDir: "{app}";     DestName: "FHIRServer.exe";       Flags: ignoreversion 32bit;  Check: not Is64BitInstallMode
Source: "C:\work\fhirserver\Exec\FHIRServer-dev64.exe";        DestDir: "{app}";     DestName: "FHIRServer.exe";       Flags: ignoreversion 64bit;  Check: Is64BitInstallMode
