...
OutputBaseFilename=FHIRServer_Install_DEV_0.10.0001
...
Source: "C:\work\org.hl7.fhir.dev\build\publish\*.*";                       DestDir: "{app}\spec";       Flags: ignoreversion recursesubdirs;  Excludes: "*.zip"
Source: "C:\work\org.hl7.fhir.dev\build\publish\examples.zip";                       DestDir: "{app}\spec";       Flags: ignoreversion;
Source: "C:\work\org.hl7.fhir.dev\build\publish\validation.zip";            DestDir: "{app}\spec";       Flags: ignoreversion recursesubdirs;  
