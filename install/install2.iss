...
AppVerName=1.0.33 (FHIR Version 1.0.2.7475)

; compilation control
OutputDir=C:\work\fhirserver\install\build
OutputBaseFilename=fhirserver2-1.0.33
...
; Executable files
Source: "C:\work\fhirserver\Exec\FHIRServer2.exe";        DestDir: "{app}";     DestName: "FHIRServer.exe";       Flags: ignoreversion
