...
uses
  ...
  SmartOnFhirLogin in '..\reference-platform\SmartOnFhirLogin.pas' {SmartOnFhirLoginForm},
  ...
  FHIRPathDebugger in '..\reference-platform\FHIRPathDebugger.pas' {FHIRPathDebuggerForm},
