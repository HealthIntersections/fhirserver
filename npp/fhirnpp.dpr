...
uses
  ...
  SmartOnFhirLogin in '..\reference-platform\dstu2\SmartOnFhirLogin.pas' {SmartOnFhirLoginForm},
  ...
  FHIRPathDebugger in '..\reference-platform\dstu2\FHIRPathDebugger.pas' {FHIRPathDebuggerForm},
