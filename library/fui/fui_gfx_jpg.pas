...
var
  ...
  FOutputFormat: TJPGColorDepth;  // tats�chlich verwendetes Format
...
begin
  ...
  begin
    // Farbtiefe bei jpgAuto �ber das Display bestimmen
    ...
    try
      ...
      if FDither then jc.d.dither_mode := JDITHER_FS  // Ordered ist nicht schneller, aber h��licher
      ...
      // Palette (bei progressiven JPEGS die endg�ltige, bei Baseline die einzige)
