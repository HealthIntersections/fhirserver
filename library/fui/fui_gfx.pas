...
Uses
  Windows, Classes, ExtCtrls, Graphics, SysUtils, {$IFDEF DELPHI}JPEG,{$ENDIF}
  Types,
  fui_gfx_compression, fui_gfx_strings, fui_gfx_color;
...
Uses
  {$IFDEF DELPHI} Consts, {$ENDIF} Math, fui_gfx_mz;
