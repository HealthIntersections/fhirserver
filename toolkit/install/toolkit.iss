...
AppVersion=0.1
AppVerName=FHIR ToolKit v0.0.64 (FHIR Version )
...
OutputBaseFilename=fhir-toolkit-install-0.0.64
...
begin
  ...
  try
    s := ',hl7.fhir.r3.core#3.0.1,hl7.fhir.r4.core#4.0.0,hl7.fhir.cda#0.0.1';
    repeat
      done := true;
