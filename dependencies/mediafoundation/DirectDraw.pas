 ...
 * callbacks
 *)
  TClipperCallback = function(lpDDClipper: IDirectDrawClipper; hWnd: HWND; Code: DWORD; lpContext: Pointer): HResult; stdcall;
 ...
 *)
  ...
  TDDEnumSurfacesCallback = function(lpDDSurface: IDirectDrawSurface; const lpDDSurfaceDesc: TDDSurfaceDesc;
    lpContext: Pointer): HResult; stdcall;
  TDDEnumSurfacesCallback2 = function(lpDDSurface: IDirectDrawSurface4; const lpDDSurfaceDesc: TDDSurfaceDesc2;
    lpContext: Pointer): HResult; stdcall;
  TDDEnumSurfacesCallback7 = function(lpDDSurface: IDirectDrawSurface7; const lpDDSurfaceDesc: TDDSurfaceDesc2;
    lpContext: Pointer): HResult; stdcall;
  //{$ENDIF}
 ...
 *)
  ...
  IDirectDraw = interface(IUnknown)
    ...
    function CreatePalette(dwFlags: DWORD; lpColorTable: Pointer; out lplpDDPalette: IDirectDrawPalette;
      pUnkOuter: IUnknown): HResult; stdcall;
    function CreateSurface(var lpDDSurfaceDesc: TDDSurfaceDesc; out lplpDDSurface: IDirectDrawSurface;
      pUnkOuter: IUnknown): HResult; stdcall;
    ...
    function EnumSurfaces(dwFlags: DWORD; const lpDDSD: TDDSurfaceDesc; lpContext: Pointer;
  ...
  IDirectDraw2 = interface(IUnknown)
    ...
    function EnumDisplayModes(dwFlags: DWORD; lpDDSurfaceDesc: PDDSurfaceDesc; lpContext: Pointer;
      lpEnumModesCallback: TDDEnumModesCallback): HResult; stdcall;
    function EnumSurfaces(dwFlags: DWORD; var lpDDSD: TDDSurfaceDesc; lpContext: Pointer;
      lpEnumCallback: TDDEnumSurfacesCallback): HResult; stdcall;
    function FlipToGDISurface: HResult; stdcall;
    function GetCaps(lpDDDriverCaps: PDDCaps; lpDDHELCaps: PDDCaps): HResult; stdcall;
    function GetDisplayMode(out lpDDSurfaceDesc: TDDSurfaceDesc): HResult; stdcall;
  ...
  IDirectDraw4 = interface(IUnknown)
    ...
    function CreatePalette(dwFlags: DWORD; lpColorTable: Pointer; out lplpDDPalette: IDirectDrawPalette;
      pUnkOuter: IUnknown): HResult; stdcall;
    function CreateSurface(const lpDDSurfaceDesc: TDDSurfaceDesc2; out lplpDDSurface: IDirectDrawSurface4;
      pUnkOuter: IUnknown): HResult; stdcall;
    function DuplicateSurface(lpDDSurface: IDirectDrawSurface4; out lplpDupDDSurface: IDirectDrawSurface4): HResult; stdcall;
    function EnumDisplayModes(dwFlags: DWORD; lpDDSurfaceDesc: PDDSurfaceDesc2; lpContext: Pointer;
      lpEnumModesCallback: TDDEnumModesCallback2): HResult; stdcall;
    function EnumSurfaces(dwFlags: DWORD; const lpDDSD: TDDSurfaceDesc2; lpContext: Pointer;
  ...
  IDirectDraw7 = interface(IUnknown)
    ...
    function CreatePalette(dwFlags: DWORD; lpColorTable: Pointer; out lplpDDPalette: IDirectDrawPalette;
      pUnkOuter: IUnknown): HResult; stdcall;
    function CreateSurface(const lpDDSurfaceDesc: TDDSurfaceDesc2; out lplpDDSurface: IDirectDrawSurface7;
      pUnkOuter: IUnknown): HResult; stdcall;
    ...
    function RestoreAllSurfaces: HResult; stdcall;
    function TestCooperativeLevel: HResult; stdcall;
    function GetDeviceIdentifier(out lpdddi: TDDDeviceIdentifier2; dwFlags: DWORD): HResult; stdcall;
 ...
 *)
  ...
  IDirectDrawSurface = interface(IUnknown)
    ...
    function Blt(lpDestRect: PRect; lpDDSrcSurface: IDirectDrawSurface; lpSrcRect: PRect; dwFlags: DWORD;
 ...
 *)
  IDirectDrawSurface4 = interface(IUnknown)
    ...
    function AddOverlayDirtyRect(const lpRect: TRect): HResult; stdcall;
    function Blt(lpDestRect: PRect; lpDDSrcSurface: IDirectDrawSurface4; lpSrcRect: PRect; dwFlags: DWORD;
      lpDDBltFx: PDDBltFX): HResult; stdcall;
    function BltBatch(const lpDDBltBatch: TDDBltBatch; dwCount: DWORD; dwFlags: DWORD): HResult; stdcall;
  ...
  IDirectDrawSurface7 = interface(IUnknown)
    ...
    function EnumOverlayZOrders(dwFlags: DWORD; lpContext: Pointer; lpfnCallback: TDDEnumSurfacesCallback7): HResult; stdcall;
...
type
  ...
  TDDEnumCallback = function(lpGUID: PGUID; lpDriverDescription: PChar; lpDriverName: PChar; lpContext: Pointer): BOOL; stdcall;

  TDDEnumCallbackExA = function(lpGUID: PGUID; lpDriverDescription: PAnsiChar; lpDriverName: PAnsiChar;
    lpContext: Pointer; Monitor: HMonitor): BOOL;
    stdcall;
  TDDEnumCallbackExW = function(lpGUID: PGUID; lpDriverDescription: PWideChar; lpDriverName: PWideChar;
    lpContext: Pointer; Monitor: HMonitor): BOOL;
    stdcall;
  TDDEnumCallbackEx = function(lpGUID: PGUID; lpDriverDescription: PChar; lpDriverName: PChar; lpContext: Pointer; Monitor: HMonitor): BOOL;
    stdcall;
...
type
  ...
  TDirectDrawEnumerate= function(lpCallback: TDDEnumCallback; lpContext: Pointer): HResult; stdcall;
  TDirectDrawEnumerateExA= function(lpCallback: TDDEnumCallbackExA; lpContext: Pointer; dwFlags: DWORD): HResult; stdcall;
  TDirectDrawEnumerateExW= function(lpCallback: TDDEnumCallbackExW; lpContext: Pointer; dwFlags: DWORD): HResult; stdcall;
  TDirectDrawEnumerateEx= function(lpCallback: TDDEnumCallbackEx; lpContext: Pointer; dwFlags: DWORD): HResult; stdcall;
  ...
  TDirectDrawCreateClipper= function(dwFlags: DWORD; out lplpDDClipper: IDirectDrawClipper; pUnkOuter: IUnknown): HResult; stdcall;

var
  DirectDrawEnumerateA: TDirectDrawEnumerateA;
  DirectDrawEnumerateW: TDirectDrawEnumerateW;
  DirectDrawEnumerate: TDirectDrawEnumerate;
  DirectDrawEnumerateExA: TDirectDrawEnumerateExA;
  DirectDrawEnumerateExW: TDirectDrawEnumerateExW;
  DirectDrawEnumerateEx: TDirectDrawEnumerateEx;
  DirectDrawCreate: TDirectDrawCreate;
  DirectDrawCreateEx: TDirectDrawCreateEx;
 ...
 *)
  ...
  IDDVideoPortContainer = interface(IUnknown)
    ...
    function CreateVideoPort(dwFlags: DWORD; var lpTDDVideoPortDesc: TDDVideoPortDesc; var lplpDDVideoPort: IDirectDrawVideoPort;
      pUnkOuter: IUnknown): HResult; stdcall;
    function EnumVideoPorts(dwFlags: DWORD; lpTDDVideoPortCaps: PDDVideoPortCaps; lpContext: Pointer;
      lpEnumVideoCallback: TDDEnumVideoCallback): HResult; stdcall;
    function GetVideoPortConnectInfo(dwPortId: DWORD; var lpNumEntries: DWORD; lpConnectInfo: PDDVideoPortConnect): HResult; stdcall;
  ...
  IDirectDrawVideoPort = interface(IUnknown)
    ...
    function GetBandwidthInfo(var lpddpfFormat: TDDPixelFormat; dwWidth: DWORD; dwHeight: DWORD; dwFlags: DWORD;
    ...
    function GetOutputFormats(var lpInputFormat: TDDPixelFormat; var lpNumFormats: DWORD; lpFormats: PDDPixelFormat;
...
function MAKEFOURCC(ch0, ch1, ch2, ch3: char): DWORD;
begin
  Result := DWORD(byte(ch0) shl 0) or DWORD(byte(ch1) shl 8) or DWORD(byte(ch2) shl 16) or DWORD(byte(ch3) shl 24);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      DirectDrawEnumerateA := TDirectDrawEnumerateA(GetProcAddress(DirectDrawLib, 'DirectDrawEnumerateA'));
      DirectDrawEnumerateW := TDirectDrawEnumerateW(GetProcAddress(DirectDrawLib, 'DirectDrawEnumerateW'));
      {$IFDEF UNICODE}
      DirectDrawEnumerate := TDirectDrawEnumerate(GetProcAddress(DirectDrawLib, 'DirectDrawEnumerateW'));
      {$ELSE}
      DirectDrawEnumerate := TDirectDrawEnumerate(GetProcAddress(DirectDrawLib, 'DirectDrawEnumerateA'));
      {$ENDIF}

      DirectDrawEnumerateExA := TDirectDrawEnumerateExA(GetProcAddress(DirectDrawLib, 'DirectDrawEnumerateExA'));
      DirectDrawEnumerateExW := TDirectDrawEnumerateExW(GetProcAddress(DirectDrawLib, 'DirectDrawEnumerateExW'));
      {$IFDEF UNICODE}
      DirectDrawEnumerateEx := TDirectDrawEnumerateEx(GetProcAddress(DirectDrawLib, 'DirectDrawEnumerateExW'));
      {$ELSE}
      DirectDrawEnumerateEx := TDirectDrawEnumerateEx(GetProcAddress(DirectDrawLib, 'DirectDrawEnumerateExA'));
      {$ENDIF}

      DirectDrawCreate := TDirectDrawCreate(GetProcAddress(DirectDrawLib, 'DirectDrawCreate'));
      DirectDrawCreateEx := TDirectDrawCreateEx(GetProcAddress(DirectDrawLib, 'DirectDrawCreateEx'));
      DirectDrawCreateClipper := TDirectDrawCreateClipper(GetProcAddress(DirectDrawLib, 'DirectDrawCreateClipper'));
      {$IFDEF WINNT}
      NtDirectDrawCreate := TNtDirectDrawCreate(GetProcAddress(DirectDrawLib, 'NtDirectDrawCreate'));
      {$ENDIF}
