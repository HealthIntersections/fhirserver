...
Acknowledgements (for version 4):
 ...
 - Marcus Mvnnig for the ScanMemoryPoolForCorruptions suggestion and the
...
Change log:
 ...
 Version 4.70 (4 August 2006):
  ...
  - Added a global variable "FullDebugModeScanMemoryPoolBeforeEveryOperation".
    ...
    when hunting for elusive memory corruption bugs. (Thanks to Marcus Mvnnig.)
  ...
  - Support added for Free Pascal's OS X and Linux targets, both i386 and
    x86-64. (Thanks to Zok Peterson - some fixes by Arnaud Bouchez)
