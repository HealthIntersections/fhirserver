...
=======
  ...
  if fileExists(FIni.ReadString('tools', 'jar', 'C:\work\org.hl7.fhir\latest-ig-publisher\org.hl7.fhir.publisher.jar'))
    then FjarFile:= FIni.ReadString('tools', 'jar', 'C:\work\org.hl7.fhir\latest-ig-publisher\org.hl7.fhir.publisher.jar');
